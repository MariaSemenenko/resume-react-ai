  ...
  return <section className="contact-map-section" aria-labelledby="contact-map-title">
    <div className="page-container">
      <div className="contact-map-heading">
        <p>Location</p>
        <h2 id="contact-map-title">Based in Ukraine,<br />working worldwide.</h2>
      </div>
      <div className="contact-map-frame">
        {GOOGLE_MAPS_KEY ? <APIProvider apiKey={GOOGLE_MAPS_KEY}>
          <Map
            ...
            zoomControl
            reuseMaps
            aria-label="Map showing the Cherkasy region of Ukraine"
          />
        </APIProvider> : <div className="contact-map-fallback" role="status">The map is temporarily unavailable.</div>}
      </div>
    </div>
  </section>
}
